$(document).ready(function(){
      ...
      fields: {
          email: {
              ...
              validators: {
                  ...
                  remote:{
                      async: true,
                      url: 'function/authentication/checkEmail.php',
                      type: 'POST',
                      data: {
                          type: 'email'
                      },
          ...
          username: {
              ...
              validators: {
                  ...
                  regexp: {
                      regexp: /^[a-z0-9_]+$/,
                      message: 'The username can only consist of alphabetical lower case, number, and underscore'
                  },
                  remote: {
                      async: true,
                      url: 'function/authentication/checkUser.php',
                      type: 'POST',
                      data: {
                          type: 'username'
                      },
  ...
  .on('success.form.fv', function(e) {
      ...
      $.ajax({
          url: 'function/authentication/registerUser.php',
          type: 'POST',
          data: $form.serialize(),
