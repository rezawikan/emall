$(document).ready(function(){
  ...
  function loadCategories(id){
    ...
    $.getJSON('function/product/LoadCategories.php', function(response) {
         var categories = '';
          $(id).html('<option value=" ">Select</option>');
         $.each(response,function(key, val) {
           categories = '<option value="'+val['categoriesID']+'" >'+val['categoryName']+'</option>';
  ...
  function loadSubCategories(sub,id){
    ...
    $.ajax({
      url: 'function/product/LoadSubCategories.php',
      type: 'POST',
      data: {categoriesID: sub},
