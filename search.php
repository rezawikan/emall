    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div>
                    <a id="add" data-toggle="modal" class="btn btn-primary distance-top" href="#modal-form-add">Add Product</a>
                    <p id='message'></p>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12"><h3 class="m-t-none m-b">Edit Product</h3>
                                        ...
                                        <form role="form" id="form-data-update" method="POST">
                                          ...
                                          <button class="btn btn-sm btn-primary ladda-button" data-style="expand-right" type="submit" name="submit-btn-update">OK</button>
                                          <button id="cancel-btn-update" class="btn btn-sm btn-primary " type="submit">Cancel</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
